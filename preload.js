...
contextBridge.exposeInMainWorld('electronBridge', {
  ...
  getCursorAutoUpdateStatus: (payload) => ipcRenderer.invoke('cursorAutoUpdate:getStatus', payload),
  disableCursorAutoUpdate: (payload) => ipcRenderer.invoke('cursorAutoUpdate:disable', payload),
  restoreCursorAutoUpdate: (payload) => ipcRenderer.invoke('cursorAutoUpdate:restore', payload),
  ...
  cursorRelayReviewBridgeStatus: (payload) => ipcRenderer.invoke('cursorRelay:reviewBridgeStatus', payload),
  cursorRelayReviewBridgeApply: (payload) => ipcRenderer.invoke('cursorRelay:reviewBridgeApply', payload),
  cursorRelayReviewBridgeRestore: (payload) => ipcRenderer.invoke('cursorRelay:reviewBridgeRestore', payload),
